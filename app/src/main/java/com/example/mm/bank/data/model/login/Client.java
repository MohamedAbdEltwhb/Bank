...
public class Client {
    ...
    public Client(Integer id, String createdAt,
                  String updatedAt, String name, String email,
                  String birthDate, String cityId, String phone,
                  String donationLastDate, String bloodType, String isActive, String pinCode) {
        this.id = id;
